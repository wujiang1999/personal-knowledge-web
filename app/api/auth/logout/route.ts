 ...
 * logs out. The browser cookie is cleared as well — without this the proxy
 * (which verifies the signature but cannot check token_version) keeps treating
 * the stale cookie as a valid session and bounces /login back to /dashboard
 * forever.
 */
